...
import { HiOutlineBell, HiOutlineSearch, HiOutlineChatAlt, HiUser, HiUserCircle } from 'react-icons/hi'
        ...
        <div className="bg-white h-16 px-4 flex items-center border-b border-gray-200 justify-end">
            <div className="flex items-center gap-2 mr-2">
                ...
                <Menu as="div" className="relative">
                    <div>
                        <Menu.Button className="ml-2 bg-blue-200 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-neutral-400">
